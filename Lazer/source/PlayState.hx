...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch(stageCheck)
		{
			...
			{
                curStage = 'bgphase';
				var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('phase2bg'));
				add(bg);
			...
			{
                curStage = 'bg';
				var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('BackgroundLazer'));
				add(bg);
				bg.scrollFactor.set(1, 1);
				bg.active = false;
				bg.updateHitbox();    
			...
			{
                curStage = 'rationbg';
				var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('TitleBG'));
	...
	function schoolIntro(?dialogueBox:DialogueBox):Void
	{
		...
		var red:FlxSprite = new FlxSprite(-100, -100).makeGraphic(FlxG.width * 2, FlxG.height * 2, 0xFF9300ff);
